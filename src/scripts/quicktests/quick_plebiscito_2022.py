...
def main():
    dataset_path = os.path.join(PROJECT_ROOT, 'data', 'raw', 'df_plebiscito_2022.csv')
    ...
    results_dir = os.path.join(PROJECT_ROOT, 'results', 'Plebiscito_2022')
    ...
    logging.info("Ejecutando clustering para Plebiscito_2022...")
    r = run_pcd.ejecutar_clustering_individual(
        dataset_path=dataset_path,
        dataset_name='Plebiscito_2022',
